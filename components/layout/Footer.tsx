            ...
            <div className={`flex ${isRTL ? 'space-x-reverse space-x-4' : 'space-x-4'}`}>
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center text-white hover:text-primary hover:bg-white/30 transition-all duration-300 hover:scale-110"
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.id}>
                  ...
                  >
                    {link.label}
                    <span className={`absolute bottom-0 ${isRTL ? 'right-0' : 'left-0'} w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full`}></span>
                  </a>
                </li>
              ))}
            </ul>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+971000000000" className="text-muted hover:text-primary transition-colors duration-300">
                  +971 00 000 0000
                </a>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:info@superarcgroup.com" className="text-muted hover:text-primary transition-colors duration-300">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            ...
            <div className={`flex ${isRTL ? 'space-x-reverse space-x-6' : 'space-x-6'}`}>
              <a
                ...
                className="text-muted hover:text-primary transition-colors duration-300 text-sm relative group"
              >
                {t.privacyPolicy}
                <span className={`absolute bottom-0 ${isRTL ? 'right-0' : 'left-0'} w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full`}></span>
              </a>
